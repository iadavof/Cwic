...
ActiveRecord::Schema.define(version: 20141217105641) do
  ...
  add_index "organisation_clients", ["confirmation_token"], name: "index_organisation_clients_on_confirmation_token", unique: true, using: :btree
  add_index "organisation_clients", ["organisation_id"], name: "index_organisation_clients_on_organisation_id", using: :btree
  add_index "organisation_clients", ["reset_password_token"], name: "index_organisation_clients_on_reset_password_token", unique: true, using: :btree
