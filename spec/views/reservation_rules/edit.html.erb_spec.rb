...
describe "reservation_rules/edit" do
  before(:each) do
  ...
  it "renders the edit reservation_rule form" do
    render

    # Run the generator again with the --webrat flag if you want to use webrat matchers
    assert_select "form[action=?][method=?]", reservation_rule_path(@reservation_rule), "post" do
