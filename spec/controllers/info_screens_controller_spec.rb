...
describe InfoScreensController do
  ...
  # InfoScreen. As you add validations to InfoScreen, be sure to
  # adjust the attributes here as well.
  let(:valid_attributes) { { "name" => "MyString" } }

  # This should return the minimal set of values that should be in the session
  # in order to pass any filters (e.g. authentication) defined in
  # InfoScreensController. Be sure to keep this updated too.
  let(:valid_session) { {} }

  describe "GET index" do
    it "assigns all info_screens as @info_screens" do
      info_screen = InfoScreen.create! valid_attributes
      get :index, {}, valid_session
      assigns(:info_screens).should eq([info_screen])
    end
  end
  ...
  describe "GET new" do
    it "assigns a new info_screen as @info_screen" do
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested info_screen" do
        info_screen = InfoScreen.create! valid_attributes
        # Assuming there are no other info_screens in the database, this
        # specifies that the InfoScreen created on the previous line
    ...
    describe "with invalid params" do
      it "assigns the info_screen as @info_screen" do
        info_screen = InfoScreen.create! valid_attributes
        # Trigger the behavior that occurs when invalid params are submitted
        InfoScreen.any_instance.stub(:save).and_return(false)
