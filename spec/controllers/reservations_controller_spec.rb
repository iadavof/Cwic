...
describe ReservationsController do
  ...
  let(:valid_attributes) { { "begins_at" => "" } }
  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved reservation as @reservation" do
        ...
        post :create, {:reservation => { "begins_at" => "invalid value" }}, valid_session
        assigns(:reservation).should be_a_new(Reservation)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested reservation" do
        ...
        Reservation.any_instance.should_receive(:update).with({ "begins_at" => "" })
        put :update, {:id => reservation.to_param, :reservation => { "begins_at" => "" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the reservation as @reservation" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Reservation.any_instance.stub(:save).and_return(false)
        put :update, {:id => reservation.to_param, :reservation => { "begins_at" => "invalid value" }}, valid_session
        assigns(:reservation).should eq(reservation)
      end
