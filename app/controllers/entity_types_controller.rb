...
private
  ...
  def resource_params
    params.require(:entity_type).permit(:name, :description, :entity_type_icon_id, entity_type_properties_attributes: [:id, :name, :description, :data_type_id, :required, :default_value, :index, :_destroy, entity_type_property_options_attributes: [:id, :name, :default, :index, :_destroy]])
  end
