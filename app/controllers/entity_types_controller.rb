...
private
  ...
  def resource_params
    params.require(:entity_type).permit(:name, :color, :description, property_types_attributes: [:id, :name, :description, :data_type_id, :required, :default_value, :index, :_destroy, property_type_options_attributes: [:id, :name, :default, :index, :_destroy]])
  end
