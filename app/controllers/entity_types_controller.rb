...
private
  ...
  def resource_params
    params.require(:entity_type).permit(:name, :color, :description, property_types_attributes: [:id, :name, :description, :data_type_id, :required, :default_value, :_destroy, property_type_options_attributes: [:id, :name, :default, :_destroy]])
  end
