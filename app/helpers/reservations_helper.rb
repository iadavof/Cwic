module ReservationsHelper
  def filter_summary(of, date_domain_from, date_domain_to)
    if of.present? && date_domain_from.present? && date_domain_to.present?
      t('.reservations_of_from_to', of: of.instance_name, from: I18n.l(date_domain_from), to: I18n.l(date_domain_to))
    elsif of.present? && date_domain_from.present?
      t('.reservations_of_from', of: of.instance_name, from: I18n.l(date_domain_from))
    elsif of.present? && date_domain_to.present?
      t('.reservations_of_to', of: of.instance_name, to: I18n.l(date_domain_to))
    elsif date_domain_from.present? && date_domain_to.present?
      t('.reservations_from_to', from: I18n.l(date_domain_from), to: I18n.l(date_domain_to))
    elsif date_domain_from.present?
      t('.reservations_from', from: I18n.l(date_domain_from))
    elsif date_domain_to.present?
      t('.reservations_to', to: I18n.l(date_domain_to))
    elsif of.present?
